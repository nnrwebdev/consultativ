...
<html>
  <head>
    ...
    <link rel="stylesheet" href="http://hangoverstudios.com/css/animation.css?1">
    <link rel="shortcut icon" href="img/favicon.png">
  </head>
    <body>
    <!-- navbar-->
    <header class="header">
      <div class="top-bar bg-dark bg_1 text-white">
        <div class="container">
          <div class="row">
            <div class="col-lg-4 bg-primary py-2 text-center text-lg-left" style="transform: skew(-30deg);">
              <p class="mb-0 text-small" style="transform: skew(30deg);><i class="fas fa-clock mr-2"></i>Opening hours: Mon - Sat 9:00 - 18:00</p>
            </div>
      ...
      <nav class="navbar navbar-expand-lg navbar-light py-3 bg-white shadow-sm">
        <div class="container"><a class="navbar-brand" href="index.php"><img src="img/sample-logo.png" alt="" width="200"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item mx-2"><a class="nav-link text-uppercase" href="about-us.php">About Us</a></li>
